...
namespace KitchenApp.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<OrdersPagePage>("Shell_OrdersPage".GetLocalized(), Symbol.Document));
            _secondaryItems.Add(ShellNavigationItem.FromType<SettingsPagePage>("Shell_SettingsPage".GetLocalized(), Symbol.Setting));
        }
